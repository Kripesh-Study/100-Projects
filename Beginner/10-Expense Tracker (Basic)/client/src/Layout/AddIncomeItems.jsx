...
const AddItems = ({closeModal,putValue,saveIncome,setCategories}) => {
  ...
  return (
    <div className='fixed top-0 left-0 overflow-hidden w-full h-screen flex items-center justify-center bg-black/50' >
        ...
        <div className='border-t flex flex-col gap-4   border-gray-300 p-3'>
          ...
          <div className='flex flex-col '>
            ...
            <div className='flex mt-3 flex-wrap gap-x-3 gap-y-2'>
              <span onClick={pickCategories}  className='bg-gray-200 px-3 py-1.5  rounded border'>Salary</span>
              <span onClick={pickCategories} className='bg-gray-200 px-3 py-1.5 rounded border'>Freelance</span>
              <span onClick={pickCategories} className='bg-gray-200 px-3 py-1.5 rounded border'>Gift</span>
              <span onClick={pickCategories} className='bg-gray-200 px-3 py-1.5 rounded border'>Investment</span>
              <span onClick={pickCategories} className='bg-gray-200 px-3 py-1.5 rounded border'>Bonus</span>
              <span onClick={pickCategories} className='bg-gray-200 px-3 py-1.5 rounded border'>Other</span>
            </div>
          </div>
          ...
          <div className='w-full flex justify-between items-center gap-2.5'>
            ...
            <button onClick={saveIncome} className='border w-full bg-blue-600 hover:bg-white hover:text-blue-600 transition-all duration-300 text-white cursor-pointer px-3 py-2 rounded '>Save Income</button>
          </div>
        </div>
      </div>
    </div>
